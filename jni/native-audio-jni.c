...
void Java_com_mumoki_saveapp_Splash_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_mumoki_saveapp_Splash_createBufferQueueAudioPlayer(JNIEnv* env,
        jclass clazz)
{
    SLresult result;
...
jboolean Java_com_mumoki_saveapp_Splash_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
void Java_com_mumoki_saveapp_Splash_setPlayingUriAudioPlayer(JNIEnv* env,
...
void Java_com_mumoki_saveapp_Splash_setLoopingUriAudioPlayer(JNIEnv* env,
...
void Java_com_mumoki_saveapp_Splash_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
void Java_com_mumoki_saveapp_Splash_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
int Java_com_mumoki_saveapp_Splash_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
...
void Java_com_mumoki_saveapp_Splash_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
void Java_com_mumoki_saveapp_Splash_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
void Java_com_mumoki_saveapp_Splash_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
void Java_com_mumoki_saveapp_Splash_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
jboolean Java_com_mumoki_saveapp_Splash_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
jboolean Java_com_mumoki_saveapp_Splash_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
...
jboolean Java_com_mumoki_saveapp_Splash_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
void Java_com_mumoki_saveapp_Splash_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
jboolean Java_com_mumoki_saveapp_Splash_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_mumoki_saveapp_Splash_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_mumoki_saveapp_Splash_shutdown(JNIEnv* env, jclass clazz)
{
